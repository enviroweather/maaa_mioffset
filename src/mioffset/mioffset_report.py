...
from mioffset.fod3 import fod_model,fod2dict,setback_text_table, fod_plot_to_ll 
from mioffset.setback_geojson import fod_geojson

# not needed for cloud function
from mioffset.setback_plots import footprint_plots,matplotlib_to_svg, write_footprint_plots
from mioffset.setback_maps import write_footprint_shapefile,write_pointsource_shapefile,  write_kml
from mioffset.mioffset_utils import add_prefix_to_filename,write_zipfile
...
def build_report_response(D, lat:float, lon:float, odor_index:int, topt = 1, version:str = "0.1")->dict:
